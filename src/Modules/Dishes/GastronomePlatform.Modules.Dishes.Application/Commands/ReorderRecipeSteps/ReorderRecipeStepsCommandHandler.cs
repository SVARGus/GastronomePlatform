...
{
    /// <summary>
    /// Обработчик команды <see cref="ReorderRecipeStepsCommand"/> (UC-DSH-023).
    /// </summary>
    /// <remarks>
    /// Состав рецепта не меняется — <c>Dish.RecalculateDishMarkers</c> не вызывается.
    /// </remarks>
    public sealed class ReorderRecipeStepsCommandHandler : ICommandHandler<ReorderRecipeStepsCommand>
    {
        ...
        /// <summary>
        /// Инициализирует новый экземпляр <see cref="ReorderRecipeStepsCommandHandler"/>.
        /// </summary>
        ...
        public ReorderRecipeStepsCommandHandler(
        ...
        public async Task<Result> Handle(
            ReorderRecipeStepsCommand request,
            CancellationToken cancellationToken)
        {
            ...
            Result reorderResult = dish.ReorderRecipeSteps(request.OrderedStepIds, _clock.UtcNow);
