...
{
    /// <summary>
    /// Позиция рецепта со свободным текстом (freeform-природа) — для случаев, когда
    /// нужного ингредиента в справочнике нет на момент публикации.
    ...
    public sealed record PublishedFreeformIngredientDto(
        Guid Id,
        int Order,
        decimal Quantity,
        Guid MeasureUnitId,
