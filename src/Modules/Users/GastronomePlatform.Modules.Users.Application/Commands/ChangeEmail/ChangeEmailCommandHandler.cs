...
namespace GastronomePlatform.Modules.Users.Application.Commands.ChangeEmail
{
    ...
    public sealed class ChangeEmailCommandHandler : ICommandHandler<ChangeEmailCommand>
    {
        ...
        /// <summary>
        /// Инициализирует новый экземпляр <see cref="ChangeEmailCommandHandler"/>.
        /// </summary>
        ...
        public ChangeEmailCommandHandler(IUserProfileRepository userProfileRepository, IAuthUserService authUserService,
        ...
        public async Task<Result> Handle(ChangeEmailCommand request, CancellationToken cancellationToken)
        {
            ...
            // Меняем в Auth — проверка уникальности внутри
            Result authResult = await _authUserService.ChangeEmailAsync(request.UserId, request.NewEmail, cancellationToken);
            ...
            // Синхронизируем зеркало в Users
