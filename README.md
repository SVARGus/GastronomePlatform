...
│   │   ├── GastronomePlatform.Common.Domain/   #   Базовые абстракции: Entity, AggregateRoot,
│   │   │                                       #   ValueObject, Result, Error, IDomainEvent
│   │   ├── GastronomePlatform.Common.Application/ #   CQRS-абстракции, интерфейсы сервисов
│   │   └── GastronomePlatform.Common.Infrastructure/ #   Middleware, логирование, расширения DI
