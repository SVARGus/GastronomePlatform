...
*   **[🎯 Общее понимание](https://github.com/SVARGus/GastronomePlatform/wiki#-клиентские-приложения-frontend)** — Цели, аудитория, требования.
*   **[🏗️ Архитектура и дизайн](https://github.com/SVARGus/GastronomePlatform/wiki#-клиентские-приложения-frontend)** — Принципы, паттерны, стек технологий.
*   **[🚀 Эксплуатация и DevOps](https://github.com/SVARGus/GastronomePlatform/wiki#-клиентские-приложения-frontend)** — Развертывание, CI/CD, мониторинг.
...
*   **[📱 Клиентские приложения](https://github.com/SVARGus/GastronomePlatform/wiki#-клиентские-приложения-frontend)** — Документация по веб-, мобильному и десктопному клиентам.
*   **[🗺️ Планирование](https://github.com/SVARGus/GastronomePlatform/wiki#-клиентские-приложения-frontend)** — Дорожная карта развития проекта.
