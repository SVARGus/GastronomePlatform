...
*   **🔗 Готовность к эволюции:** Архитектура спроектирована для плавного перехода к микросервисной модели.
...
Для локального запуска потребуются [.NET 8 SDK](https://dotnet.microsoft.com/download) и [Docker](https://www.docker.com/get-started).
...
Полное описание: [Wiki: Структура проекта](https://github.com/SVARGus/GastronomePlatform/wiki/13_Структура-проекта)
...
*   **Архитектор и разработчик:** [SVARGus](https://github.com/SVARGus)
