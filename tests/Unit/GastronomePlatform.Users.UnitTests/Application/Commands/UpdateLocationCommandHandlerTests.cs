...
{
    /// <summary>
    /// Тесты для <see cref="UpdateLocationCommandHandler"/>.
    /// </summary>
    public sealed class UpdateLocationCommandHandlerTests
    {
        ...
        private static UpdateLocationCommand CreateCommand() =>
            new(_userId, Country: "Россия", Region: "Краснодарский край", City: "Краснодар");
        ...
        {
            Action action = () => new UpdateLocationCommandHandler(null!, _dateTimeProviderMock.Object);
        ...
        {
            Action action = () => new UpdateLocationCommandHandler(_repositoryMock.Object, null!);
        ...
        [Fact]
        public async Task Handle_WhenProfileExists_UpdatesLocationAndSavesAsync()
        {
            // Arrange
