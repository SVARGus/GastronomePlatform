...
## Authorization (Этап 2)

- Доступно всем авторизованным пользователям.
- На Этапе 3+ — добавится проверка через `ISubscriptionService`: Premium-подписчики или автор блюда. Для Premium-помеченных рецептов гости и обычные пользователи получат `403`.
...
- **Premium-проверка** через `ISubscriptionService` — Этап 3+.
